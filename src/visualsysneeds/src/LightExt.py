...
class visual:
    ...
    def entry():
        ...
        while True:
            ...
            counter =counter + 1
            cv2.putText(frame,(Visibility(gray, h, w)),(320-70,30), font, 0.5,(255,255,255),2)
            cv2.putText(frame,(Visibility(gray2,h, 320)),(10,240), font, 0.5,(255,255,255),2)
            cv2.putText(frame,(Visibility(gray3,h, 320)),(w-100,240), font, 0.5,(255,255,255),2)
